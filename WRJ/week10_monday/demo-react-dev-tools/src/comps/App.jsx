...
function App() {
  ...
  const [person, setPerson] = useState({ name: 'Sebbe', age: 35, role: 'Educator' }); {/* state hook, kommer senare i kursen. data = getter, setData = setter  */ }
  ...
  const clickHandler = () => {
    ...
    console.info("Något gick fel i clickHandler")
  }
