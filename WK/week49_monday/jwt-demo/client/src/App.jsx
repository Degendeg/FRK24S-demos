...
function App() {
  ...
  return (
    <div className="App">
      ...
      {jwtToken &&
        <div className="wrapper">
          <p style={{ borderLeft: '8px solid green', paddingLeft: '30px', maxWidth: '400px' }}>
            JWT token: <span style={{ wordBreak: 'break-word' }}>{jwtToken}</span>
          </p>
        </div>
      }
      {response &&
        <div className="wrapper">
          <p style={{ borderLeft: '8px solid blue', paddingLeft: '30px', maxWidth: '400px' }}>
            {response}
          </p>
        </div>
      }
      ...
      <div className="clearfix"></div>
      <button onClick={handleRestricted}>Access Restricted</button>
    </div>
  );
}
